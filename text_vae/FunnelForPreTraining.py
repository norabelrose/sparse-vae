...
class FunnelForPreTraining(pl.LightningModule):
    ...
    def training_step(self, batch: Dict[str, Tensor], batch_index: int, optimizer_index: int = 0) -> Tensor:
        ...
        # Train discriminator
            ...
            generator_output = self.generator(masked_text, padding_mask=padding_mask).final_state
            ...
            discriminator_output = self.discriminator(samples, padding_mask=padding_mask).final_state
