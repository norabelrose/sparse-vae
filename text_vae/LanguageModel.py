...
class LanguageModel(pl.LightningModule, ABC):
    def __init__(self, hparams: DictConfig):
        ...
        # The LanguageModel object itself may not use the tokenizer, but various callbacks need access to a tokenizer
        # so it seems like this is the best place to put the shared one
